# Generated by Django 5.1.6 on 2025-05-25 13:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('lecturer', 'Lecturer'), ('academic_registrar', 'Academic_registrar'), ('admin', 'Administrator')], default='student', max_length=20)),
                ...
                ('lecture_number', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(blank=True, limit_choices_to={'role': 'lecturer'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),

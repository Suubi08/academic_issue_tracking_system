  ...
  return (
    <div className="flex-1 p-4 md:p-6 max-w-6xl mx-auto w-full">
      <div className="border rounded-lg p-6">
        <h1 className="text-2xl font-semibold text-center mb-6">Academic Issue Report Form</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2 mb-6">
              <label htmlFor="description" className="block text-sm font-medium">Issue Description</label>
              <textarea
                id="description"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <label htmlFor="attachment" className="block text-sm font-medium">Attachment</label>

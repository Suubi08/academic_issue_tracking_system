...
function IssueDetail() {
  ...
  const [submitting, setSubmitting] = useState(false);
      ...
      const handleClick_1 = () => {
          navigate("/studentissues"); // Replace with the actual route
      };
  ...
  return (
    <div className="space-y-6">
      <Button variant="ghost" className="flex items-center gap-2 mb-4" onClick={handleClick_1}>
        ...
        <CardHeader>
          <div className="flex justify-between items-start">
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-gray-500">Created: {new Date(issue.created_at).toLocaleDateString()}</p>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          ...
          <div className="mb-8">
            ...
            <form onSubmit={handleStatusUpdate} className="flex gap-4 items-end">
              ...
              <Button type="submit" disabled={submitting || statusUpdate === issue.status}>

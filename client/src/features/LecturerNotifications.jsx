...
const mockNotifications = [
  {
    ...
    message:
      "You have been assigned a new issue: 'Assignment submission error'",
  ...
  },
  {
    ...
    message:
      "The issue 'Grade discrepancy' needs to be resolved within 24 hours",
  ...
  },
  {
    ...
    message:
      "The issue 'Course material access problem' has been marked as resolved",
  ...
  },
  {
    ...
    message:
      "You have received a new message from student Sarah Davis regarding Quiz timing issue",
  ...
  },
  {
    ...
    message:
      "The system will be under maintenance on April 2nd from 2:00 AM to 4:00 AM",

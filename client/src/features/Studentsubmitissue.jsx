    ...
    <div className="flex-1 p-4 md:p-6 max-w-6xl mx-auto w-full">
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 pb-1 border-b">Issue Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="space-y-2">
                <label htmlFor="category" className="block">Issue Category</label>
                <select
                  id="category"
              ...
              <div className="space-y-2">
                <label htmlFor="dateOfIssue" className="block">Date of Issue</label>
                <input
                  id="dateOfIssue"
                  type="date"
                  ...
                  className="w-full p-2 border border-gray-300 rounded"
                />
                {errors.dateOfIssue && <p className="text-red-600 text-sm">{errors.dateOfIssue}</p>}
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-2">
                <label htmlFor="courseUnit" className="block">Course Unit</label>
                <select
                  id="courseUnit"
              ...
              <div className="space-y-2">
                <label htmlFor="lecturer" className="block">Lecturer</label>
                <input
                  id="lecturer"
                  type="search"
            ...
            <div className="space-y-2 mb-6">
              <label htmlFor="description" className="block">Issue Description</label>
              <textarea
                id="description"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                ...
                {errors.attachment && <p className="text-red-600 text-sm">{errors.attachment}</p>}
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <label htmlFor="semester" className="block">Semester</label>
                <select
                  id="semester"
          ...
          <div className="flex justify-end gap-4 pt-4">
            <button type="button" className="w-32 p-2 border border-gray-300 rounded" onClick={handleCancel}>
              Cancel
            </button>

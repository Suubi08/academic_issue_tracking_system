...
function Layout() {
  ...
  const getPageDescription = () => {
    ...
    if (path.includes("/lecturer-dashboard")) return "Lecturer dashboard overview"
    if (path.includes("/registrar-dashboard")) return "Registrar dashboard overview"
  ...
  const shouldShowReportButton = () => {
    const path = location.pathname
    return !path.includes("/issuereport") && !path.includes("/settings") && userRole === "student"
  }
